from Preln.preprocessing import accents, lowercasing, punctuation_es, numbers_cleanner, stopwords_es, date
import unittest
...
class TestCore(unittest.TestCase):
  ...
  def test_stopwords(self):
    text = 'Hola Adrián'
    test = stopwords_es(text=text, debug=False) # Check method failure, only using the package it works correctly
